...
#-------------------------------------------------------------------------
	...
	if (isset($params['example_syntax'])) 
	{
		...
		$smarty->assign('settingstext', $this->Lang('frontend_head_settings'));
		$smarty->assign('syntax_settingstext', $this->Lang('frontend_syntaxarea_settings'));
		$smarty->assign('head_description', $this->Lang('head_description'));
		$smarty->assign('content_description', $this->Lang('content_description'));
		...
		/* modes */
		$smarty->assign('frontend_syntax_mode', $this->Lang('syntax_mode'));
			$modes = array(
